...
const createSoftDeleteExtension_2 = require("./lib/createSoftDeleteExtension");
async function createSoftDeleteExtensionSync(config) {
    return await (0, createSoftDeleteExtension_2.createSoftDeleteExtension)({ ...config, clientPath: "@prisma/client" });
}
